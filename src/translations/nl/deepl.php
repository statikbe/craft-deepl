...
return [
    "Entries in the primary site are not allowed to be translated. Contact support for further questions." => "Pagina\'s uit de primaire site kunnen niet vertaald worden. Contacteer support voor meer informatie.",
    "Translate this page with content from:" => "Vertaal deze pagina met inhoud uit:",
